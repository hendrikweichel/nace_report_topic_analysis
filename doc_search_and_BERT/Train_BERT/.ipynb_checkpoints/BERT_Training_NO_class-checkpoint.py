...
results_path = mypath + "doc_search_and_BERT/Train_BERT/results/results_data_2__cos_thresh_06" + os.path.basename(model_name)
results_path = mypath + f"doc_search_and_BERT/Train_BERT/results/___results_null_classifiers__cos_thres_{new_thresh}__num_layers_{num_layers}" + os.path.basename(model_name)
if train_full_model: 
